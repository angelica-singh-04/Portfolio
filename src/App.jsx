      ...
      <div className="w-1/2 flex flex-col items-start text-left">
        ...
        <div className="mt-4 mb-6">
              <img
                src={photo}
                alt="photo"
                className="w-24 h-24 rounded-lg object-cover border-0 border-black rotate-356"
              />
        </div>
...
<nav
      ...
      >
        ...
        {[
          ...
          { icon: resume, href: "https://drive.google.com/file/d/1IiJTM5zTqmfg9PaRgPEtThre3rGePuHY/view?usp=sharing", label: "Resume" },
          ...
          { icon: mode, href: "#", label: "Mode", onClick: toggleMode }, // toggle
        ].map((item, index) => (
          <a
            key={index}
            href={item.href}
            onClick={item.onClick} // Only the Mode icon will toggle
